...
plt.tight_layout()
plt.savefig('results/test_adv_imp.png', format='png', dpi=1000)
...
plt.savefig('results/confusion_matrix_adversarial.png', format='png', dpi=1000)
...
plt.savefig('results/confusion_matrix_raw_number.png', format='png', dpi=1000)
