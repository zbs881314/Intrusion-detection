...
scale = 2
awid = SNN.Awid(path=["dataset/X_test.npy","dataset/y_test.npy"])
...
while(True):
    xs, ys = awid.next_batch(BATCH_SIZE, shuffle=False)
    ...
    #print(ys_1)
    #print(y_pred)
    layerout = to_categorical(layerout, 4)
...
actions = y_pred
maped = y_test
attack_types = ['normal', 'flooding', 'injection', 'impersonation']
